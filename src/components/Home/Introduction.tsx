  ...
  return (
    ...
    <div className="top-container relative !py-20 max-sm:!py-10 flex max-[900px]:flex-col-reverse max-[900px]:gap-y-10 items-center justify-between">
      <div className="space-y-5 ">
        ...
        <img src="/SVGs/plus.svg" alt="plus" className="absolute top-0 right-16 max-sm:right-0" />
      </div>
      ...
      <div className="px-10">
        <Image
          ...
          width={390}
          height={470}
          className="hover:scale-95 min-w-[390px] min-h-[470px] max-sm:min-w-0 max-sm:min-h-0 transition-all duration-500 rounded shadow-2xl shadow-primary/20 relative"
